...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <Link to='https://fumcs.github.io/'>FUMCS English website</Link>
    ),
  },
  {
    title: 'Curriculum',
    ...
    description: (
      <Link to='/docs/category/curriculum'>
        Proposed undergraduate Computer Science curriculum
      </Link>
    ),
  },
  {
    ...
    description: (
      <Link to='https://fumcs.github.io/projects/'>Research projects</Link>
    ),
  },
];
